...
public class Recording {
    ...
    public Recording(String audioUrl, String cloudinaryPublicId, Integer duration, String gearUsed, Long id, String mediaType, String notes, LocalDate recordedAt, String tags, String title, String videoUrl) {
